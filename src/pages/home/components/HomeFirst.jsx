...
import flight from "../../../assets/1.png"
...
const HomeFirst = ({ homeSecondRef }) => {
  ...
  return (
    <div className="relative h-screen flex flex-col shadow-lg  md:flex-row items-center gap-6 md:justify-between px-6 py-8 md:py-12 rounded-xl w-screen overflow-hidden" style={{ backgroundImage: `url(${flight})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
      {/* Desktop Content */}
