...
const VisaCard = ({ image, city, country, price, rating, description, id }) => {
  ...
  return (
    <div className="max-w-[280px] min-w-[260px] cursor-pointer mx-auto bg-white rounded-e-2xl overflow-hidden transform hover:scale-105 transition-transform duration-300">
