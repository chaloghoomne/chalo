...
const VisaProcessSteps = ({ country }) => {
  return (
    <div className="max-w-3xl mx-auto py-6">
      <h2 className="text-2xl font-extrabold text-gray-800 mb-10 text-center bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
      ...
      <div className="space-y-12">
        ...
        <div className="relative flex items-start">
          <div className="flex flex-col items-center mr-6">
            <div className="relative">
              ...
              <div className="absolute top-10 left-5 w-1 h-44 bg-gradient-to-b from-blue-500 to-blue-100"></div>
            </div>
          </div>
          <div className="bg-white p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 rounded-lg w-full border-l-4 border-blue-500">
        ...
        <div className="relative flex items-start">
          <div className="flex flex-col items-center mr-6">
            <div className="relative">
              ...
              <div className="absolute top-10 left-5 w-1 h-40 bg-gradient-to-b from-blue-500 to-blue-100"></div>
            </div>
          </div>
          <div className="bg-white p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 rounded-lg w-full border-l-4 border-blue-500">
            <div className="flex items-center mb-2">
        ...
        <div className="relative flex items-start">
          ...
          <div className="bg-white p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 rounded-lg w-full border-l-4 border-blue-500">
            ...
            <div className="mt-4 bg-gradient-to-r from-gray-50 to-blue-50 p-4 rounded-lg ml-11 border border-blue-100">
              <div className="flex items-center justify-between mb-2 hover:bg-white p-2 rounded transition-colors duration-200">
